...
const cart = [
  {
    ...
    description: `Ultra V Idebenone Ampoule is an intensive anti-aging treatment for brighter and younger-looking skin. It will hydrate and brighten the skin while visibly improving signs of ageing like wrinkles and fine lines. You can expect your skin to look and feel more moisturized and have a shine all day long with the help of some great ingredients.`,
    ...
    tabs: {
      ...
      ingdet: `<p>Part 1: Water, Butylene Glycol, Glycerin , Caprylic/Capric Triglyceride, Hydrogenated
                ...
                Fruit Oil, Tocopheryl Acetate </p><br>
        
            <p>Part 2: Water, Galactomyces Ferment Filtrate, Niacinamide, Butylene Glycol, Polyglutamic
      ...
      how_to_use: `<ul>
                    <li>1.Press the button on top of the ampoule to release the yellow ingredients (Fresh
                        Idebenone)
                    </li>
  ...
  // 2.Aqua shine sheet mask
  {
    ...
    description: `This facial mask is unique as it combines the simplicity of a sheet mask with some of the latest cutting-edge ingredients which is why we like to call it a ‘Treatment Mask’. The results after using this product will be above and beyond your average sheet mask because of the ingredients used in its formulation. You can expect your skin to look and feel brighter, more moisturised and healthier almost instantly.`,
  ...
  // 3.Idebenone Cream
  {
    ...
    description: `Idebenone Cream by Ultra V is a dual functional formula that will provide both whitening as well as anti-wrinkle benefits. This cream will moisturise the skin without causing any kind of irritation while also helping minimise the negative impact of the sun on the skin. The formula contains some cutting-edge ingredients that will leave the skin looking and feeling firmer, younger and brighter.`,
    option: ["20ml"],
    tabs: {
      pd: `
  ...
  // 4.Renewderm Plus
  {
    ...
    description: `It is the ultimate post-procedure cream that forms a breathable silicone protective film on the skin to help protect and heal it. It also claims irritated skin, controls moisture balance, and improves skin texture while reducing the chances of PIH after
        procedures.`,
    option: ["60mg,5ml"],
    tabs: {
      pd: `
            <p id="nav-home-p">
            It is the ultimate post-procedure cream that forms a breathable silicone protective film on the skin to help protect and heal it. It also claims irritated skin, controls moisture balance, and improves skin texture while reducing
            the chances of PIH after procedures.
            </p>
            ...
            <p style="font-weight: bold; color: #f3b239;">KEY INGREDIENTS:</p>
                <div class="keyingr">
                    ...
                    <p>Effectively helps heal wounds by controlling keloid and hypertrophic scars as it increases reconstruction of skin connective tissue.
                    </p>
      ...
      ingdet: `<p>Active ingredients: Dimethicone 7.63%</p><br>
                <p>Inactive ingredients: Water, Glycerin, Cyclopentasiloxane, Butylene Glycol, Centella Asiatica Extract, Cyclohexasiloxane, Arbutin, Alcohol, PEG/PPG-19/19 Dimethicone, Beta-Glucan,Biosaccharide Gum-1, Piper Methysticum Leaf/Root/Stem
      ...
      how_to_use: `<ul>
        <p>Can be used after: </p>
        <li>1.Post all kinds of laser procedures</li>
        <p>(Fraxel, IPL, CO2, ND Yag, Lazer Toning & more)</p>
  ...
  // 5.Pep
  {
    ...
    description: `Experience younger and brighter skin with the miraculous ampoule with a high concentrate of
        the highest ranked anti-oxidant – patented Idebenone, hyaluronic acid, niacinamide, EGF and
        so much more.`,
    option: ["6ml x 4 vials"],
    tabs: {
      pd: `
            <p id="nav-home-p">
            It is a solution that has superior skin regeneration properties and is recommended to be used after intensive procedures. With 100% fresh EGF (Epidermal Growth Factor) as a key ingredient it has many benefits for your skin, including wrinkle improvement,
            hydration, and pigmentation prevention.
            </p>

            <p style="font-weight:bold;color: #f3b239;">KEY BENEFITS:</p>
            <ul>
                <li>1.Daily nutrition and regeneration skincare</li>
                <li>2.Has anti-aging and brightening benefits </li>
                <li>3.Acts as a regenerating essence for super sensitive and extremely dry skin</li>
                <li>4.Reduces hyperpigmentation that may be caused after intensive skin treatments</li>
                <li>5.Improves the epidermis and protects cells from free radicals</li>
                <li>6.You can expect brighter younger looking skin after using this solution</li>
            </ul>
      ...
      ingdet: `<p>INGREDIENTS (PART 1) Water, Sodium Hyaluronate, 1,2-Hexanediol, Magnesium Ascorbyl Phosphate, Mannitol,Acetyl Cysteine, Butylene Glycol, Sodium DNA, Glycine, Proline, Lysine, Leucine sh-Oligopeptide-5, Copper Tripeptide-1,
                Acetyl Tetrapeptide-11
            </p><br>
        
            <p>INGREDIENTS (PART 2) Water, Galactomyces Ferment Filtrate, Butylene Glycol, 1,2-Hexanediol, Bacillus/Soybean Ferment Extract, Centella Asiatica Extract, Fomes Officinalis (Mushroom) Extract, Bambusa Arundinacea Stem Extract,
